...
export default function User_Term(props) {
  const { nome, cpf, email, senha } = props.route.params
      ...
      <Text style={styles.bTextPrimary}>Termos de Uso</Text>
        <ScrollView 
          ...
          onScroll={({nativeEvent}) => 
            setAccepted(isCloseToBottom(nativeEvent))
          }
        >
        ...
        <TouchableOpacity disabled={ !accepted } 
          onPress={() => signUp(nome, cpf, email, senha)}
